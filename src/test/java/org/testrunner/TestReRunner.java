...
@CucumberOptions(features = "@src\\test\\resources\\rerun\\failedscenarios.txt", glue = "org.stepdefinition", snippets = SnippetType.UNDERSCORE, dryRun = false, monochrome = true, strict = false, plugin = {
